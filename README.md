...
## 📥 Download Release (v0.0.26)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.26-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.26/Termora-v0.0.26-macOS.dmg)

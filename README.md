...
## 📥 Download Release (v0.0.16)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.16-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.16/Termora-v0.0.16-macOS.dmg)

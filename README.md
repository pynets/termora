...
## 📥 Download Release (v0.0.36)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.36-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.36/Termora-v0.0.36-macOS.dmg)

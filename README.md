...
## 📥 Download Release (v0.0.3)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.3-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.3/Termora-v0.0.3-macOS.dmg)

...
## 📥 Download Release (v0.0.15)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.15-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.15/Termora-v0.0.15-macOS.dmg)

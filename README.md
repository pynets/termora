...
## 📥 Download Release (v0.0.19)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.19-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.19/Termora-v0.0.19-macOS.dmg)

...
## 📥 Download Release (v0.0.8)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.8-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.8/Termora-v0.0.8-macOS.dmg)

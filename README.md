...
## 📥 Download Release (v0.0.20)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.20-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.20/Termora-v0.0.20-macOS.dmg)

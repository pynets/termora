...
## 📥 Download Release (v0.0.40)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.40-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.40/Termora-v0.0.40-macOS.dmg)

...
## 📥 Download Release (v0.0.9)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.9-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.9/Termora-v0.0.9-macOS.dmg)

...
## 📥 Download Release (v0.0.22)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.22-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.22/Termora-v0.0.22-macOS.dmg)

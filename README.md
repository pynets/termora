...
## 📥 Download Release (v0.0.25)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.25-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.25/Termora-v0.0.25-macOS.dmg)

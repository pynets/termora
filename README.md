...
## 📥 Download Release (v0.0.21)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.21-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.21/Termora-v0.0.21-macOS.dmg)

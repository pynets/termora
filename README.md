...
## 📥 Download Release (v0.0.2)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.2-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.2/Termora-v0.0.2-macOS.dmg)

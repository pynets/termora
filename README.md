...
## 📥 Download Release (v0.0.23)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.23-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.23/Termora-v0.0.23-macOS.dmg)

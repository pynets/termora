...
## 📥 Download Release (v0.0.6)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.6-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.6/Termora-v0.0.6-macOS.dmg)

...
## 📥 Download Release (v0.0.24)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.24-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.24/Termora-v0.0.24-macOS.dmg)

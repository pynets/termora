...
## 📥 Download Release (v0.0.41)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.41-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.41/Termora-v0.0.41-macOS.dmg)

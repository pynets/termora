...
## 📥 Download Release (v0.0.18)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.18-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.18/Termora-v0.0.18-macOS.dmg)

...
## 📥 Download Release (v0.0.39)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.39-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.39/Termora-v0.0.39-macOS.dmg)

...
## 📥 Download Release (v0.0.17)

- **macOS Installer (.dmg)**: [Download Termora-v0.0.17-macOS.dmg](https://github.com/pynets/termora/releases/download/v0.0.17/Termora-v0.0.17-macOS.dmg)
